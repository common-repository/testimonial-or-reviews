...
function orphita_testimonial_or_reviews_shortcode_function_style12($styleid, $userdata, $styledata, $listdata) {
    ...
    <div class="orphita-testimonials-wrapper">
        ...
        echo '<style>
            ...
            .orphita-testimonials-style-' . $styleid . '{
                ...
                float: left;
                position: relative;
                border-bottom: ' . $styledata[99] . 'px solid ' . $styledata[101] . ';
            ...
            .orphita-testimonials-style-' . $styleid . ':hover{
                cursor: pointer;
                -webkit-box-shadow:' . $styledata[109] . 'px ' . $styledata[111] . 'px ' . $styledata[113] . 'px ' . $styledata[115] . 'px ' . $styledata[121] . ';
                -moz-box-shadow: ' . $styledata[109] . 'px ' . $styledata[111] . 'px ' . $styledata[113] . 'px ' . $styledata[115] . 'px ' . $styledata[121] . ';
                -ms-box-shadow:' . $styledata[109] . 'px ' . $styledata[111] . 'px ' . $styledata[113] . 'px ' . $styledata[115] . 'px ' . $styledata[121] . ';
                -o-box-shadow: ' . $styledata[109] . 'px ' . $styledata[111] . 'px ' . $styledata[113] . 'px ' . $styledata[115] . 'px ' . $styledata[121] . ';
                box-shadow: ' . $styledata[109] . 'px ' . $styledata[111] . 'px ' . $styledata[113] . 'px ' . $styledata[115] . 'px ' . $styledata[121] . ';
                    }
            .orphita-testimonials-style-' . $styleid . '-image{
                position: relative;
                display: block;
                margin: ' . $styledata[123] . 'px auto ' . $styledata[123] . 'px 0;
            ...
            .orphita-testimonials-right .orphita-testimonials-style-' . $styleid . '-image{
                margin: ' . $styledata[123] . 'px 0 ' . $styledata[123] . 'px  auto;
            }
            ...
            .orphita-testimonials-style-' . $styleid . '-info{
                padding-top: ' . $styledata[167] . 'px;
                padding-bottom:' . $styledata[169] . 'px;
                width: 100%;
                float: left;  
                position: relative;
