...
function orphita_testimonial_or_reviews_shortcode_function_style10($styleid, $userdata, $styledata, $listdata) {
    ...
    <div class="orphita-testimonials-wrapper">
        ...
        echo '<style>
            ...
            .orphita-testimonials-style-' . $styleid . '{
                ...
                float: left;
                position: relative;
                border: ' . $styledata[141] . 'px solid ' . $styledata[143] . ';
                margin-top: ' . $styledata[119] / 2 . 'px; 
                padding-top: ' . $styledata[119] / 2 . 'px; 
