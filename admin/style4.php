...
if (!empty($_POST['submit']) && $_POST['submit'] == 'submit') {
    if (!wp_verify_nonce($nonce, 'orphita_testimonial_or_reviews_new_data')) {
        ...
        $data = '{#}|{#}{#}|{#}testimonial-name {#}|{#}' . sanitize_text_field($_POST['testimonial-name']) . '{#}|{#}'
                ...
                . ' testimonial-company {#}|{#}' . sanitize_text_field($_POST['testimonial-company']) . '{#}|{#}';
        if ($_POST['item-id'] == '') {
...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'orphita_testimonial_or_reviews_style_css')) {
        ...
        $data = ' orphita-carousel |' . sanitize_text_field($_POST['orphita-carousel']) . '|'
                ...
                . 'boxshow-color|rgba(229, 189, 255, 1)|'
                ...
                . 'typo-image-border-color|#d1d1d1|'
                ...
                . 'typo-name-color|#858585|'
                . 'image-padding-left||'
                . 'image-padding-right|' . sanitize_text_field($_POST['image-padding-right']) . '|'
                ...
                . 'typo-rating-size||'
                . 'typo-rating-color||'
                . 'typo-rating-margin-top||'
                . 'typo-rating-margin-bottom||'
                . 'testimonial-position|' . sanitize_text_field($_POST['testimonial-position']) . '|'
                . 'typo-company-size|' . sanitize_text_field($_POST['typo-company-size']) . '|'
                . 'typo-company-color|#a500c2|'
                . 'typo-company-hover-color|#bf00af|'
                . 'typo-company-family|Open+Sans|'
                . 'typo-company-style|' . sanitize_text_field($_POST['typo-company-style']) . '|'
                . 'typo-company-weight|' . sanitize_text_field($_POST['typo-company-weight']) . '|'
                . 'typo-company-padding-top|' . sanitize_text_field($_POST['typo-company-padding-top']) . '|'
                . 'typo-company-padding-left|' . sanitize_text_field($_POST['typo-company-padding-left']) . '|'
                . 'custom-css||'
                . '|';
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select class="form-control" id="testimonial-position" name="testimonial-position">
                                                            ...
                                                            ?> value="">Left</option>       
                                                            <option <?php
                                                            if ($styledata[175] == 'orphita-testimonials-center') {
                                                                echo 'selected';
                                                            }
                                    ...
                                    <div class="orphita-tabs-content-tabs" id="orphita-tabs-id-4">
                                        <div class="orphita-tabs-content-div-half">
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                <?php
                                                echo orphita_testimonial_or_reviews_admin_number('typo-image-Width', $styledata[117], '1', 'Image Width', 'Set your Image Width.');
                                                echo orphita_testimonial_or_reviews_admin_number('typo-image-height', $styledata[119], '1', 'Image Height', 'Set your Front Height.');
                                                echo orphita_testimonial_or_reviews_admin_number('image-padding-right', $styledata[151], '1', 'Padding Right', 'Set your Padding Right.');
                                        ...
                                        <div class="orphita-tabs-content-div-half">
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_number_double('typo-name-padding-top', $styledata[161], 'typo-name-padding-left', $styledata[163], 'Padding', 'Set Your Name  Padding Top Bottom and Left Right');
                                                ?> 
                                            </div>
                                            <div class="orphita-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                <?php
                                                echo orphita_testimonial_or_reviews_admin_number('typo-company-size', $styledata[177], '1', 'Font Size', 'Set your Company Font Size');
                                                echo orphita_testimonial_or_reviews_admin_color('typo-company-color', $styledata[179], '', 'Color', 'Set your Company Color');
                                                echo orphita_testimonial_or_reviews_admin_color('typo-company-hover-color', $styledata[181], '', 'Hover Color', 'Set your Company Hover Color');
                                                echo orphita_testimonial_or_reviews_admin_font_family('typo-company-family', $styledata[183], 'Font Family', 'Give your Prepared Font from our Google Font List');
                                                echo orphita_testimonial_or_reviews_admin_font_style('typo-company-style', $styledata[185], 'Font Style', 'Set your Font Style');
                                                echo orphita_testimonial_or_reviews_admin_font_weight('typo-company-weight', $styledata[187], 'Font Weight', 'Give your  Font Weight');
                                                echo orphita_testimonial_or_reviews_admin_number_double('typo-company-padding-top', $styledata[189], 'typo-company-padding-left', $styledata[191], 'Padding', 'Set Your Padding Top Bottom and Left Right');
                                                ?> 
                                            </div>                                          
                                        </div>
                                    </div>                                
                                    ...
                                    <div class="orphita-tabs-content-tabs" id="orphita-tabs-id-2">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo $styledata[193]; ?></textarea>
                    ...
                    <form method="POST">
                        <div class="modal-content">                            
                            ...
                            <div class="modal-body">
                                ...
                                echo orphita_testimonial_or_reviews_admin_input_text('testimonial-company', $editdata[13], 'Writer Company', 'Add Writer Company Name.');
