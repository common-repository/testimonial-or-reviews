...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'orphita_testimonial_or_reviews_style_css')) {
        ...
        $data = ' orphita-carousel |' . sanitize_text_field($_POST['orphita-carousel']) . '|'
                ...
                . 'boxshow-color|rgba(164, 34, 240, 0.32)|'
                ...
                . 'image-padding-top|' . sanitize_text_field($_POST['image-padding-top']) . '|'
                . 'image-padding-left|' . sanitize_text_field($_POST['image-padding-left']) . '|'
                ...
                . 'typo-name-color|#ffffff|'
                . 'typo-name-back-color|rgba(217, 0, 156, 1)|'
                . 'typo-name-hover-color|#ffffff|'
                . 'typo-name-hover-back-color|rgba(156, 0, 112, 1)|'
                ...
                . 'typo-name-border-radius|' . sanitize_text_field($_POST['typo-name-border-radius']) . '|'
                                    ...
                                    <div class="orphita-tabs-content-tabs" id="orphita-tabs-id-4">
                                        <div class="orphita-tabs-content-div-half">
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_number_double('image-padding-top', $styledata[121], 'image-padding-left', $styledata[123], 'Padding Top Bottom', 'Set your Front Padding as Top and Bottom');
                                        ...
                                        <div class="orphita-tabs-content-div-half">
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_color('typo-name-back-color', $styledata[149], 'rgba', 'Background Color', 'Set your Name Background Color');
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_color('typo-name-hover-back-color', $styledata[153], 'rgba', 'Hover Background Color', 'Set your Name Hover Background Color');
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_number('typo-name-border-radius', $styledata[165], '1', 'Border Radius', 'Set your Name Font Size');
                                                ?> 
                                            </div>    
                                            <div class="orphita-tabs-content-div">
                                                <div class="head-oxi">
                                    ...
                                    <div class="orphita-tabs-content-tabs" id="orphita-tabs-id-2">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo $styledata[175]; ?></textarea>
