...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'orphita_testimonial_or_reviews_style_css')) {
        ...
        $data = ' orphita-carousel |' . sanitize_text_field($_POST['orphita-carousel']) . '|'
                ...
                . 'background-color |rgba(207, 16, 207, 1)|'
                ...
                . 'boxshow-color|rgba(207, 16, 207, 1)|'
                                    ...
                                    <div class="orphita-tabs-content-tabs" id="orphita-tabs-id-4">
                                        <div class="orphita-tabs-content-div-half">
                                            ...
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_number_double('typo-info-padding-top', $styledata[141], 'typo-info-padding-bottom', $styledata[143], 'Margin Top Bottom', 'Set Your Info Margin Top and Bottom');
                                                ?> 
                                            </div>
                                        </div>
                                        <div class="orphita-tabs-content-div-half">
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_color('typo-name-hover-color', $styledata[151], '', 'Hover Color', 'Set your Name Color');
