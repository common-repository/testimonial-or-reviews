...
if (!empty($_POST['submit']) && $_POST['submit'] == 'submit') {
    if (!wp_verify_nonce($nonce, 'orphita_testimonial_or_reviews_new_data')) {
        ...
        $data = ' {#}|{#}{#}|{#}testimonial-name {#}|{#}' . sanitize_text_field($_POST['testimonial-name']) . '{#}|{#}'
                . ' testimonial-icon{#}|{#}' . sanitize_text_field($_POST['testimonial-icon']) . '{#}|{#}'
...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'orphita_testimonial_or_reviews_style_css')) {
        ...
        $data = ' orphita-carousel |' . sanitize_text_field($_POST['orphita-carousel']) . '|'
                ...
                . 'boxshow-color|rgba(133, 119, 119, 1)|'
                ...
                . 'typo-image-margin-bottom|' . sanitize_text_field($_POST['typo-image-margin-bottom']) . '|'
                . '||'
                . 'typo-image-border-size|' . sanitize_text_field($_POST['typo-image-border-size']) . '|'
                . 'typo-image-border-color|#edeff0|'
                ...
                . 'typo-info-padding-bottom|' . sanitize_text_field($_POST['typo-info-padding-bottom']) . '|'
                . 'typo-name-size|' . sanitize_text_field($_POST['typo-name-size']) . '|'
                . 'typo-name-color|#f2624d|'
                . 'typo-info-margin-top|' . sanitize_text_field($_POST['typo-info-margin-top']) . '|'
                . 'typo-info-margin-bottom|' . sanitize_text_field($_POST['typo-info-margin-bottom']) . '|'
                . '||'
                ...
                . 'typo-icon-hover-Color|#f2624d|'
                . 'typo-quote-size|' . sanitize_text_field($_POST['typo-quote-size']) . '|'
                . 'typo-quote-color|rgba(234, 236, 238, 1)|'
                . 'typo-icon-font-size|' . sanitize_text_field($_POST['typo-icon-font-size']) . '|'
                . 'typo-icon-Color|' . sanitize_hex_color($_POST['typo-icon-Color']) . '|'
                                    ...
                                    <div class="orphita-tabs-content-tabs" id="orphita-tabs-id-5">
                                        <div class="orphita-tabs-content-div-half">
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_testimonial_position('testimonial-position', $styledata[175], 'Text Align', 'Set your Testimonial Text Position');
                                                ?>    
                                            </div> 
                                            <div class="orphita-tabs-content-div">
                                                <div class="head-oxi">
                                    ...
                                    <div class="orphita-tabs-content-tabs" id="orphita-tabs-id-4">
                                        <div class="orphita-tabs-content-div-half">
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_number('typo-image-margin-bottom', $styledata[121], '1', 'Margin Bottom', 'Set your Front Image Margin Bottom.');
                                                ?>    
                                            </div> 
                                            <div class="orphita-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_number_double('typo-info-padding-top', $styledata[141], 'typo-info-padding-bottom', $styledata[143], 'Padding Top Bottom', 'Set Your Info Padding Top and Bottom');
                                                ?> 
                                            </div>
                                            <div class="orphita-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                <?php
                                                echo orphita_testimonial_or_reviews_admin_number('typo-quote-size', $styledata[167], '1', 'Font Size', 'Set your Quote Font Size');
                                                echo orphita_testimonial_or_reviews_admin_color('typo-quote-color', $styledata[169], 'rgba', 'Color', 'Set your Quote Color');
                                                echo orphita_testimonial_or_reviews_admin_number('typo-info-margin-top', $styledata[149], '1', 'Top Quote Position ', 'Set your Top Quote Position');
                                                echo orphita_testimonial_or_reviews_admin_number('typo-info-margin-bottom', $styledata[151], '1', 'Bottom Quote Position ', 'Set your Bottom Quote Position');
                                                ?>
                                            </div>
                                        </div>
                                        <div class="orphita-tabs-content-div-half">
                                            ...
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                <?php
                                                echo orphita_testimonial_or_reviews_admin_number('typo-designation-size', $styledata[177], '1', 'Font Size', 'Set your Font Size');
                                                echo orphita_testimonial_or_reviews_admin_color('typo-designation-color', $styledata[179], '', 'Color', 'Set your Designation Color');
                                                echo orphita_testimonial_or_reviews_admin_font_family('typo-designation-family', $styledata[185], 'Font Family', 'Give your Prepared Font from our Google Font List');
                                                echo orphita_testimonial_or_reviews_admin_font_style('typo-designation-style', $styledata[187], 'Font Style', 'Set your Name Font Style');
                                                echo orphita_testimonial_or_reviews_admin_font_weight('typo-designation-weight', $styledata[189], 'Font Weight', 'Give your Name Font Weight');
                                                echo orphita_testimonial_or_reviews_admin_number_double('typo-designation-padding-top', $styledata[191], 'typo-name-designation-left', $styledata[193], 'Padding Top Bottom', 'Set Your Name  Padding Top Bottom');
                                                ?> 
                                            </div> 
                                            <div class="orphita-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                <?php
                                                echo orphita_testimonial_or_reviews_admin_number('typo-icon-font-size', $styledata[171], '1', 'Font Size', 'Set your Icon Font Size');
                                                echo orphita_testimonial_or_reviews_admin_color('typo-icon-Color', $styledata[173], '1', 'Color', 'Set your Icon Color');
                                                echo orphita_testimonial_or_reviews_admin_color('typo-icon-hover-Color', $styledata[165], '1', 'Hover Color', 'Set your Icon Hover Color');
                                                ?>
                                            </div>
                                        </div>
                                    </div>                                
                                    ...
                                    <div class="orphita-tabs-content-tabs" id="orphita-tabs-id-2">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo $styledata[195]; ?></textarea>
                    ...
                    <form method="POST">
                        <div class="modal-content">                            
                            ...
                            <div class="modal-body">
                                ...
                                echo orphita_testimonial_or_reviews_admin_input_text('testimonial-designation', $editdata[13], 'Writer Designation', 'Add Writer Designation.');
                                ...
                                echo orphita_testimonial_or_reviews_admin_input_text('testimonial-icon', $editdata[5], 'Icon', 'Give your Testimonial Icon as Example fa-globe');
