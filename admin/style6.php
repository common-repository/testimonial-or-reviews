...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'orphita_testimonial_or_reviews_style_css')) {
        ...
        $data = ' orphita-carousel |' . sanitize_text_field($_POST['orphita-carousel']) . '|'
                ...
                . 'background-color |rgba(231, 87, 73, 1)|'
                ...
                . 'boxshow-color|rgba(231, 87, 73, 1)|'
                ...
                . 'image-to-name-padding-top|' . sanitize_text_field($_POST['image-to-name-padding-top']) . '|'
                . 'typo-quote-size|' . sanitize_text_field($_POST['typo-quote-size']) . '|'
                . 'typo-quote-color|rgba(255, 255, 255, 1)|'
                . 'typo-designation-size|' . sanitize_text_field($_POST['typo-designation-size']) . '|'
                . 'typo-designation-color|#e75749|'
                . 'typo-designation-hover-color|#242222|'
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select class="form-control" id="testimonial-position" name="testimonial-position">
                                                            ...
                                                            ?> value="">Left</option>                                                            
                                                            <option <?php
                                                            if ($styledata[149] == 'orphita-testimonials-right') {
                                                                echo 'selected';
                                                            }
                                    ...
                                    <div class="orphita-tabs-content-tabs" id="orphita-tabs-id-4">
                                        <div class="orphita-tabs-content-div-half">
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_number('image-padding-top', $styledata[121], '1', 'Margin Top', 'Set your Front Padding as Top and Bottom');
                                                echo orphita_testimonial_or_reviews_admin_number('image-to-name-padding-top', $styledata[165], '1', 'Padding', 'Set your Front Padding from Name and Designation');
                                        ...
                                        <div class="orphita-tabs-content-div-half">
                                            ...
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_color('typo-designation-hover-color', $styledata[175], '', 'Hover Color', 'Set your Designation Hover Color');
                ...
                <div class="orphita-admin-style-panel-left-preview">
                    <div class="orphita-admin-style-panel-left-preview-heading">
                        ...
                        <div class="orphita-admin-style-panel-left-preview-heading-right">
                            <input type="text" class="form-control orphita-color"  data-format="rgb" data-opacity="true"  id="orphita-preview-data-background" value="(255, 255, 255, 1)">
                        </div>
                    </div>
