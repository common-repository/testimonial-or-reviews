...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'orphita_testimonial_or_reviews_style_css')) {
        ...
        $data = ' orphita-carousel |' . sanitize_text_field($_POST['orphita-carousel']) . '|'
                ...
                . 'boxshow-color|' . sanitize_text_field($_POST['boxshow-color']) . '|'
                ...
                . 'image-padding-bottom|' . sanitize_text_field($_POST['image-padding-bottom']) . '|'
                . 'typo-image-border-size|' . sanitize_text_field($_POST['typo-image-border-size']) . '|'
                . 'typo-image-border-color|#e75749|'
                ...
                . 'typo-info-border-top|' . sanitize_text_field($_POST['typo-info-border-top']) . '|'
                . 'typo-info-border-bottom|' . sanitize_text_field($_POST['typo-info-border-bottom']) . '|'
                . 'typo-name-size|' . sanitize_text_field($_POST['typo-name-size']) . '|'
                . 'typo-name-color|#4a4040|'
                . 'testimonial-position|' . sanitize_text_field($_POST['testimonial-position']) . '|'
                . 'typo-info-border-color|#e75749|'
                . 'typo-info-hover-border-color|#000000|'
                ...
                . 'typo-name-padding-bottom|' . sanitize_text_field($_POST['typo-name-padding-bottom']) . '|'
                . 'typo-name-hover-color|#f00303|'
                . 'typo-info-border-bottom-point|' . sanitize_text_field($_POST['typo-info-border-bottom-point']) . '|'
                . '||'
                . 'typo-designation-size|' . sanitize_text_field($_POST['typo-designation-size']) . '|'
                . 'typo-designation-color|#737373|'
                . '||'
                                    ...
                                    <div class="orphita-tabs-content-tabs" id="orphita-tabs-id-4">
                                        <div class="orphita-tabs-content-div-half">
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_number_double('image-padding-top', $styledata[121], 'image-padding-bottom', $styledata[123], 'Padding Top Bottom', 'Set your Front Padding as Top and Bottom');
                                            ...
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_number('typo-info-border-top', $styledata[141], '1', 'Top Border Size', 'Give your Top Border Size');
                                                echo orphita_testimonial_or_reviews_admin_number('typo-info-border-bottom', $styledata[143], '1', 'Bottom Border Size', 'Give your Bottom Border Size');
                                                echo orphita_testimonial_or_reviews_admin_color('typo-info-border-color', $styledata[151], '', 'Border Color', 'Set your Info Border Color');
                                                echo orphita_testimonial_or_reviews_admin_color('typo-info-hover-border-color', $styledata[153], '', 'Hover Border Color', 'Set your Info Hover Border Color');
                                                echo orphita_testimonial_or_reviews_admin_number('typo-info-border-bottom-point', $styledata[167], '1', 'Border Bottom Point', 'Give your Bottom Border Point');
                                                ?> 
                                            </div>                                            
                                        </div>
                                        <div class="orphita-tabs-content-div-half">
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_color('typo-name-hover-color', $styledata[165], '', 'Hover Color', 'Set your Name Hover Color');
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_number_double('typo-name-padding-top', $styledata[161], 'typo-name-padding-bottom', $styledata[163], 'Padding Top Bottom', 'Set Your Name  Padding Top Bottom');
                                                ?> 
                                            </div> 
                                            <div class="orphita-tabs-content-div">
                                                <div class="head-oxi">
