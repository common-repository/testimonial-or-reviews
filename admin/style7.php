...
if (!empty($_POST['submit']) && $_POST['submit'] == 'submit') {
    if (!wp_verify_nonce($nonce, 'orphita_testimonial_or_reviews_new_data')) {
        ...
        $data = ' {#}|{#}{#}|{#}testimonial-name {#}|{#}' . sanitize_text_field($_POST['testimonial-name']) . '{#}|{#}'
                ...
                . ' testimonial-works-at {#}|{#}' . sanitize_text_field($_POST['testimonial-works-at']) . '{#}|{#}';
        if ($_POST['item-id'] == '') {
...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'orphita_testimonial_or_reviews_style_css')) {
        ...
        $data = ' orphita-carousel |' . sanitize_text_field($_POST['orphita-carousel']) . '|'
                ...
                . 'boxshow-color|rgba(237, 232, 232, 1)|'
                ...
                . 'typo-image-border-color|#8add1b|'
                ...
                . 'typo-name-color|#8d8889|'
                . 'typo-arrow-width|' . sanitize_text_field($_POST['typo-arrow-width']) . '|'
                . 'typo-arrow-height|' . sanitize_text_field($_POST['typo-arrow-height']) . '|'
                . 'typo-arrow-background-color|rgba(138, 221, 27, 1)|'
                ...
                . 'typo-quote-color|rgba(222, 222, 222, 1)|'
                . 'typo-info-padding-left|' . sanitize_text_field($_POST['typo-info-padding-left']) . '|'
                . 'typo-info-padding-right|' . sanitize_text_field($_POST['typo-quote-size']) . '|'
                ...
                . 'typo-designation-color|#8d8889|'
                . 'typo-company-color|#8add1b|'
                . 'typo-company-hover-color|#acc789|'
                                    ...
                                    <div class="orphita-tabs-content-tabs" id="orphita-tabs-id-4">
                                        <div class="orphita-tabs-content-div-half">
                                            ...
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_number_double('typo-info-padding-left', $styledata[171], 'typo-info-padding-right', $styledata[173], 'Padding Left Right', 'Set Your Info Padding Left and Right');
                                                ?> 
                                            </div>
                                            <div class="orphita-tabs-content-div">
                                                <div class="head-oxi">
                                        ...
                                        <div class="orphita-tabs-content-div-half">
                                            ...
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                <?php
                                                echo orphita_testimonial_or_reviews_admin_number('typo-arrow-width', $styledata[149], '1', 'Width', 'Set your Arrow Width');
                                                echo orphita_testimonial_or_reviews_admin_number('typo-arrow-height', $styledata[151], '1', 'Height', 'Set your Arrow Height');
                                                echo orphita_testimonial_or_reviews_admin_color('typo-arrow-background-color', $styledata[153], 'rgba', 'Background Color', 'Set your Arrow Background Color');
                                                ?>
                                            </div>
                                            <div class="orphita-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                echo orphita_testimonial_or_reviews_admin_color('typo-company-color', $styledata[181], '', 'Company Color', 'Set your Company Background Color');
                                                echo orphita_testimonial_or_reviews_admin_color('typo-company-hover-color', $styledata[183], '', 'Company Hover Color', 'Set your Company Hover Color');
                    ...
                    <form method="POST">
                        <div class="modal-content">                            
                            ...
                            <div class="modal-body">
                                ...
                                echo orphita_testimonial_or_reviews_admin_input_text('testimonial-works-at', $editdata[15], 'Writer Company', 'Add Writer Working Company.');
