...
if (!empty($_POST['submit']) && $_POST['submit'] == 'submit') {
    if (!wp_verify_nonce($nonce, 'orphita_testimonial_or_reviews_new_data')) {
        ...
        $data = ' {#}|{#}{#}|{#}testimonial-name {#}|{#}' . sanitize_text_field($_POST['testimonial-name']) . '{#}|{#}'
                . ' testimonial-rating {#}|{#}' . sanitize_text_field($_POST['testimonial-rating']) . '{#}|{#}'
...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'orphita_testimonial_or_reviews_style_css')) {
        ...
        $data = ' orphita-carousel |' . sanitize_text_field($_POST['orphita-carousel']) . '|'
                ...
                . 'boxshow-color|rgba(161, 34, 240, 1)|'
                ...
                . 'typo-name-color|#616161|'
                . 'typo-name-back-color||'
                . 'typo-name-hover-color||'
                . 'typo-name-hover-back-color||'
                ...
                . 'typo-name-border-radius||'
                . 'typo-rating-size|' . sanitize_text_field($_POST['typo-rating-size']) . '|'
                . 'typo-rating-color|#b600d6|'
                . 'typo-rating-margin-top|' . sanitize_text_field($_POST['typo-rating-margin-top']) . '|'
                . 'typo-rating-margin-bottom|' . sanitize_text_field($_POST['typo-rating-margin-bottom']) . '|'
                ...
                . 'typo-designation-color|#858585|'
                . 'typo-company-color|#b51ec9|'
                . 'typo-company-hover-color|#8100a8|'
                                    ...
                                    <div class="orphita-tabs-content-tabs" id="orphita-tabs-id-4">
                                        ...
                                        <div class="orphita-tabs-content-div-half">
                                            ...
                                            <div class="orphita-tabs-content-div">
                                                ...
                                                <?php
                                                echo orphita_testimonial_or_reviews_admin_number('typo-rating-size', $styledata[167], '1', 'Font Size', 'Set your Rating Font Size');
                                                echo orphita_testimonial_or_reviews_admin_color('typo-rating-color', $styledata[169], '', 'Color', 'Set your Rating Color');
                                                echo orphita_testimonial_or_reviews_admin_number_double('typo-rating-margin-top', $styledata[171], 'typo-rating-margin-bottom', $styledata[173], 'Margin Top Bottom', 'Set Your Rating  Margin Top Bottom');
                                                ?> 
                                            </div>
                                        </div>
                                    </div>                                
                    ...
                    <form method="POST">
                        <div class="modal-content">                            
                            ...
                            <div class="modal-body">
                                ...
                                echo orphita_testimonial_or_reviews_admin_input_text('testimonial-rating', $editdata[5], 'Writer Rating', 'Add Writer Rating basd on number 1-5 as example 3.5');
