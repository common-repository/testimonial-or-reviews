...
jQuery("#boxshow-color").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{box-shadow: " + jQuery("#boxshow-horizontal").val() + "px " + jQuery("#boxshow-vertical").val() + "px " + jQuery("#boxshow-blur").val() + "px " + jQuery("#boxshow-spread").val() + "px " + jQuery(this).val() + "; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#boxshow-horizontal").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{box-shadow: " + jQuery(this).val() + "px " + jQuery("#boxshow-vertical").val() + "px " + jQuery("#boxshow-blur").val() + "px " + jQuery("#boxshow-spread").val() + "px " + jQuery("#boxshow-color").val() + "; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#boxshow-vertical").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{box-shadow: " + jQuery("#boxshow-horizontal").val() + "px " + jQuery(this).val() + "px " + jQuery("#boxshow-blur").val() + "px " + jQuery("#boxshow-spread").val() + "px " + jQuery("#boxshow-color").val() + "; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#boxshow-blur").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{box-shadow: " + jQuery("#boxshow-horizontal").val() + "px " + jQuery("#boxshow-vertical").val() + "px " + jQuery(this).val() + "px " + jQuery("#boxshow-spread").val() + "px " + jQuery("#boxshow-color").val() + "; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#boxshow-spread").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{box-shadow: " + jQuery("#boxshow-horizontal").val() + "px " + jQuery("#boxshow-vertical").val() + "px " + jQuery("#boxshow-blur").val() + "px " + jQuery(this).val() + "px " + jQuery("#boxshow-color").val() + "; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-image-Width").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-left{width: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
    ...
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-right{width: calc(100% - " + jQuery(this).val() + "px); } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#image-to-name-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-right{padding: 0 " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#typo-info-size").on("change", function () {
    ...
    var value1 = parseInt(jQuery("#padding-left").val(), 10);
    var value = (intvalue * 1.3) * 5 + (value1 * 2);
...
jQuery("#background-color").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{background-color: " + jQuery(this).val() + "; } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#border-radius-top").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{border-radius: " + jQuery(this).val() + "px " + jQuery("#border-radius-bottom").val() + "px; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#border-radius-bottom").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{border-radius: " + jQuery("#border-radius-top").val() + "px " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#padding-top").on("change", function () {
...
jQuery("#padding-left").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{padding: " + jQuery("#padding-top").val() + "px " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
    var intvalue = parseInt(jQuery("#typo-info-size").val(), 10);
    var value1 = parseInt(jQuery(this).val(), 10);
    var value = (intvalue * 1.3) * 5 + (value1 * 2);
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{min-height: " + value + "px; } </style>").appendTo("#orphita-preview-data");
    var intvalue = parseInt(jQuery(this).val(), 10);
    var value = (intvalue / 2);
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info .fa{margin: 0 -" + value + "px; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-quote-size").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info .fa{font-size: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-quote-color").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info .fa{color: " + jQuery(this).val() + "; } </style>").appendTo("#orphita-preview-data");
});
