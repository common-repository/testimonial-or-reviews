...
jQuery("#typo-border-size").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "{border: " + jQuery(this).val() + "px solid " + jQuery("#typo-border-color").val() + "; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-border-color").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "{border: " + jQuery("#typo-border-size").val() + "px solid " + jQuery(this).val() + "; } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#typo-image-height").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-image{height: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
    var intvalue = parseInt(jQuery(this).val(), 10);
    var value = (intvalue / 2);
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-image{top: - " + value + "px; } </style>").appendTo("#orphita-preview-data");
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "{margin-top: " + value + "px; } </style>").appendTo("#orphita-preview-data");
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "{padding-top: " + value + "px; } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#typo-info-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{padding: " + jQuery(this).val() + "px 0 " + jQuery("#typo-info-padding-left").val() + "px 0; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-info-padding-left").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{padding: " + jQuery("#typo-info-padding-top").val() + "px 0 " + jQuery(this).val() + "px 0; } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#typo-name-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-name, a .orphita-testimonials-style-" + styleid + "-name{padding: " + jQuery(this).val() + "px 0 " + jQuery("#typo-name-padding-left").val() + "px 0; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-name-padding-left").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-name, a .orphita-testimonials-style-" + styleid + "-name{padding: " + jQuery("#typo-name-padding-top").val() + "px 0 " + jQuery(this).val() + "px 0; } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#typo-designation-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-working{padding: " + jQuery(this).val() + "px 0 " + jQuery("#typo-name-designation-left").val() + "px 0; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-name-designation-left").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-working{padding: " + jQuery("#typo-designation-padding-top").val() + "px 0 " + jQuery(this).val() + "px 0; } </style>").appendTo("#orphita-preview-data");
});
