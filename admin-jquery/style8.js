...
jQuery("#typo-image-margin-bottom").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-"+styleid+"-image{margin: 0 auto " + jQuery(this).val() + "px 0; } </style>").appendTo("#orphita-preview-data");
    jQuery("<style type='text/css'> .orphita-testimonials-right .orphita-testimonials-style-"+styleid+"-image{margin: 0 0 " + jQuery(this).val() + "px auto; } </style>").appendTo("#orphita-preview-data");
    jQuery("<style type='text/css'> .orphita-testimonials-center .orphita-testimonials-style-"+styleid+"-image{margin: 0 auto " + jQuery(this).val() + "px auto; } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#typo-info-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-"+styleid+"-info{padding: " + jQuery(this).val() + "px " + jQuery("#typo-info-padding-bottom").val() + "px; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-info-padding-bottom").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-"+styleid+"-info{padding: " + jQuery("#typo-info-padding-top").val() + "px " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-quote-size").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-"+styleid+"-info:before, .orphita-testimonials-style-"+styleid+"-info:after{font-size: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-quote-color").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-"+styleid+"-info:before, .orphita-testimonials-style-"+styleid+"-info:after{color: " + jQuery(this).val() + "; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-info-margin-top").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-"+styleid+"-info:before{top: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-info-margin-bottom").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-"+styleid+"-info:after{bottom: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#typo-icon-font-size").on("change", function () {
    var intvalue = parseInt(jQuery(this).val(), 10);
    var value = (intvalue + 10);
    jQuery("<style type='text/css'> .orphita-testimonials-style-"+styleid+"-name-body-left{width:calc 100% - " + value + "px; } </style>").appendTo("#orphita-preview-data");
    jQuery("<style type='text/css'> .orphita-testimonials-style-"+styleid+"-name-body-right{width: " + value + "px; } </style>").appendTo("#orphita-preview-data");
    jQuery("<style type='text/css'> .orphita-testimonials-style-"+styleid+"-name-body-right .fa{font-size: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-icon-Color").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-"+styleid+"-name-body-right .fa{color: " + jQuery(this).val() + "; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-icon-hover-Color").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-"+styleid+"-name-body-right .fa:hover{color: " + jQuery(this).val() + "; } </style>").appendTo("#orphita-preview-data");
});
