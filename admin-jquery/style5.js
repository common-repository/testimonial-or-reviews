...
jQuery("#border-radius-bottom").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{border-radius: " + jQuery("#border-radius-top").val() + "px " + jQuery(this).val() + "; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#padding-top").on("change", function () {
...
jQuery("#padding-left").on("change", function () {
    ...
    var value = (intvalue * 1.3) * 5 + (value1 * 2);
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{min-height: " + value + "px; } </style>").appendTo("#orphita-preview-data");
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info:after{left: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info:after{right: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#typo-name-size").on("change", function () {
    ...
    var intvalue = parseInt(jQuery(this).val(), 10);
    var value1 = parseInt(jQuery("#typo-name-padding-top").val(), 10);
    var value = ((intvalue + value1) / 2);
...
jQuery("#typo-name-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-name{padding: " + jQuery(this).val() + "px 0 " + jQuery("#typo-name-padding-left").val() + "px; } </style>").appendTo("#orphita-preview-data");
...
jQuery("#typo-name-padding-left").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-name{padding: " + jQuery("#typo-name-padding-top").val() + "px 0 " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});