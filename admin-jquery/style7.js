...
jQuery("#typo-image-Width").on("change", function () {
    ...
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-padding{margin-top: " + value + "px; } </style>").appendTo("#orphita-preview-data");
    ...
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{padding-top: " + value + "px; } </style>").appendTo("#orphita-preview-data");
...
jQuery("#typo-info-padding-bottom").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{padding-bottom: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#typo-arrow-width").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-name:after{width: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-arrow-height").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-name:after{height: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-arrow-background-color").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-name:after{background: " + jQuery(this).val() + "; } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#typo-company-hover-color").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-working a:hover, .orphita-testimonials-style-" + styleid + "-working a:focus, .orphita-testimonials-style-" + styleid + "-working a:active{color: " + jQuery(this).val() + "; } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#typo-info-padding-left").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{padding-left: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-info-padding-right").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-info{padding-right: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});