...
jQuery("#testimonial-position").on("change", function () {
    jQuery(".orphita-testimonials-item-" + styleid + "").removeClass("orphita-testimonials-center");
    jQuery(".orphita-testimonials-item-" + styleid + "").removeClass("orphita-testimonials-right");
    jQuery(".orphita-testimonials-item-" + styleid + "").addClass(jQuery("#testimonial-position").val());
});
...
jQuery("#image-padding-right").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-right{padding-left: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
    jQuery("<style type='text/css'> .orphita-testimonials-right .orphita-testimonials-style-" + styleid + "-right{padding-right: " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});
...
jQuery("#typo-company-size").on("change", function () {
...
jQuery('#typo-company-family').change(function () {
    var font = jQuery(this).val().replace(/\+/g, ' ');
    font = font.split(':');
...
jQuery("#typo-company-style").on("change", function () {
...
jQuery("#typo-company-weight").on("change", function () {
...
jQuery("#typo-company-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-working{padding: " + jQuery(this).val() + "px 0 " + jQuery("#typo-company-padding-left").val() + "px; } </style>").appendTo("#orphita-preview-data");
});
jQuery("#typo-company-padding-left").on("change", function () {
    jQuery("<style type='text/css'> .orphita-testimonials-style-" + styleid + "-working{padding: " + jQuery("#typo-company-padding-top").val() + "px 0 " + jQuery(this).val() + "px; } </style>").appendTo("#orphita-preview-data");
});